...
const StatCard = ({
    ...
    return (
        <div className="md:row-span-1 xl:row-span-2 col-span-1 bg-white shadow-md rounded-2xl flex flex-col justify-between">
            {/* HEADER */}
            <div>
                        ...
                        <React.Fragment key={index}>
                            <div className="flex items-center justify-between my-4">
                                ...
                                <div className="flex items-center">
                                    ...
                                    >
                                        {formatPercentage(detail.changePercent)}
                                    </span>
                                </div>
                            </div>
